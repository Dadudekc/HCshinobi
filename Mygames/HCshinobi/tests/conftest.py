...
async def integration_services(setup_test_data_dir) -> ServiceContainer:
    ...
    # Use TEST_DATA_DIR which is the base for the services
    services = ServiceContainer(data_dir=TEST_DATA_DIR)
    
    # We don't need to manually init each service here if ServiceContainer handles it
    # Ensure services are initialized (ServiceContainer __init__ should do this)
    # Example: Mock external dependencies if needed
    # services.external_api = AsyncMock()
