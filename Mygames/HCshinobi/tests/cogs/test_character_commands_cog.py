...
@pytest.fixture
def mock_bot():
    """Fixture to create a mock bot with mock services."""
    bot = MagicMock(spec=["services"])
    bot.services = MagicMock()
    bot.services.character_system = AsyncMock()
    bot.services.clan_assignment_engine = AsyncMock()
    # Add other services if needed by the cog
    return bot
...
class TestCharacterCommands:
    ...
    async def test_create_character_already_exists(self, character_cog, mock_interaction, mock_bot):
        ...
        mock_bot.services.character_system.get_character.return_value = mock_existing_character
        ...
        mock_bot.services.character_system.get_character.assert_awaited_once_with("1234567890")
        # Ensure create_character was NOT called
        mock_bot.services.character_system.create_character.assert_not_awaited()
    ...
    async def test_profile_success(self, character_cog, mock_interaction, mock_bot):
        ...
        mock_bot.services.character_system.get_character.return_value = mock_character
        ...
        if not hasattr(mock_bot.services, 'currency_system'):
            mock_bot.services.currency_system = AsyncMock()
        if not hasattr(mock_bot.services, 'token_system'):
            mock_bot.services.token_system = AsyncMock()
        
        # Ensure the specific methods are AsyncMocks *before* setting return_value
        mock_bot.services.currency_system.get_player_balance = AsyncMock()
        mock_bot.services.token_system.get_player_tokens = AsyncMock()
        
        # Target the correct methods called in the profile command
        mock_bot.services.currency_system.get_player_balance.return_value = 1000
        mock_bot.services.token_system.get_player_tokens.return_value = 5 # Assuming this is the corresponding method
        ...
        mock_bot.services.currency_system.get_player_balance.assert_called_once_with("1234567890")
        mock_bot.services.token_system.get_player_tokens.assert_called_once_with("1234567890")
    ...
    async def test_profile_no_character(self, character_cog, mock_interaction, mock_bot):
        ...
        mock_bot.services.character_system.get_character.return_value = None
    ...
    async def test_stats_self_success(self, character_cog, mock_interaction, mock_bot):
        ...
        mock_bot.services.character_system.get_character.assert_awaited_once_with(user_id)
        mock_interaction.followup.send.assert_awaited_once()
    ...
    async def test_stats_self_no_character(self, character_cog, mock_interaction, mock_bot):
        ...
        # Arrange
        user_id = mock_interaction.user.id
        mock_bot.services.character_system.get_character.return_value = None # No character exists
    ...
    async def test_stats_other_user_success(self, character_cog, mock_interaction, mock_bot):
        ...
        mock_bot.services.character_system.get_character.assert_awaited_once_with(target_user_mock.id)
        mock_interaction.followup.send.assert_awaited_once()
    ...
    async def test_stats_other_user_no_character(self, character_cog, mock_interaction, mock_bot):
        ...
        mock_bot.services.character_system.get_character.return_value = None # Target user has no character
    ...
    async def test_delete_command_no_character(self, character_cog, mock_interaction, mock_bot):
        ...
        # Arrange
        user_id = mock_interaction.user.id
        mock_bot.services.character_system.get_character.return_value = None # No character
    ...
    async def test_inventory_empty(self, character_cog, mock_interaction, mock_bot):
        ...
        mock_bot.services.item_registry = mock_item_registry
        ...
        mock_bot.services.item_registry.get_item.assert_not_called()
        mock_interaction.followup.send.assert_awaited_once()
    ...
    async def test_jutsu_empty(self, character_cog, mock_interaction, mock_bot):
        ...
        mock_bot.services.jutsu_system = mock_jutsu_system
