...
class TestTrainingCommands:
    ...
    async def test_training_status_active(self, training_cog, mock_interaction_training, mock_bot_training):
        ...
        status_embed = discord.Embed(title="⏳ Training Status")
        status_embed.add_field(name="Details", value=f"Currently training: **Attribute**\nIntensity: **Intensity**", inline=False)
        status_embed.add_field(name="Time Remaining", value=f"<t:1234567890:R>", inline=False)
